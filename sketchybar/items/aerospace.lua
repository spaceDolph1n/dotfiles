			...
			for _, space_name in ipairs(monitor_spaces) do
				local space = sbar.add("item", "space." .. space_name, {
					...
					label = {
						...
						color = visible_set[space_name] and colors.black or colors.grey,
						font = {
					...
					padding_left = 1,
					background = {
						color = visible_set[space_name] and colors.teal or colors.transparent,
						border_width = 0,
						height = 26,
					},
				...
				space:subscribe("aerospace_workspace_change", function(env)
					...
					sbar.exec("aerospace list-workspaces --monitor all --visible", function(visible_workspaces)
						...
						space:set({
							...
							background = { color = visible_set[space_name] and colors.teal or colors.transparent },
						})
					end)
				end)
